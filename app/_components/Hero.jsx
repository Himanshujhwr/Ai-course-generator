...
function Hero() {
  return (
      ...
      <main >
          ...
          rounded-full border-[#4D4D4D] bg-primary hover:bg-black group transition-all flex 
          items-center justify-center gap-4 hover:shadow-xl hover:shadow-neutral-500 duration-500">
                                  <span
                                      className="bg-clip-text text-tranparent bg-gradient-to-r from-neutral-500 to-neutral-600
          md:text-center font-snas group-hover:bg-gradient-to-r group-hover:from-black group-hover:to-black">
                          ...
                          <h1
                              className="text-5xl md:text-8xl bg-clip-text text-transparent bg-gradient-to-b
    from-primary to-neutral-600 font-sans font-bold mb-5">
                              <span className="block">Automate Your</span> 
                              <span>Course with AI</span>
                          </h1>
                      </div>
                  }
              />
              <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
                  <a
                      ...
                      <span className="text-sm font-medium">
                          AshisTheCoder.com All new Apps
                      </span>
                      <svg
